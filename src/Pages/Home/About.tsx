...
const About: React.FC = () => {
    return (
        <section className={`bg-smoke 2xl:pb-20 dark:bg-dark ${sectionPadding}`}>
            ...
            <Link to="/about" className={`flex items-center gap-1 w-full justify-end mt-8 text-primary hover:underline font-bold ${homePageLinkFontSize}`}>Learn more<FaArrowRight /></Link>
        </section >
    )
}
