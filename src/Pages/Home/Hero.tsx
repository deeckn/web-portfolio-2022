        ...
        <section className={`${sectionPadding} bg-smoke dark:bg-dark max-h-screen`}>
            ...
            <motion.div
                ...
                <ul className='flex gap-16'>
                    ...
                    <li className={`font-bold text-primary ${homePageLinkFontSize}`}>
                        <a href='https://www.linkedin.com/in/chakrin-deesit-076804209' target={"_blank"} rel="noreferrer" className='flex items-center gap-1 hover:underline cursor-pointer'>Linkedin<FaArrowRight /></a>
                    </li>
                </ul>
            </motion.div>
            <Controls
