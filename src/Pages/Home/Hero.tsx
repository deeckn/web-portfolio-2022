    ...
    return (
        <section className='h-screen'>
            <div className='flex flex-col h-full justify-center mx-8 sm:mx-8 md:mx-36 lg:mx-72 xl:mx-96'>
                ...
                <button className='font-bold text-white border-solid border-orange border-4 rounded-full px-4 py-2 mt-8 w-fit md:text-lg hover:bg-orange transition-colors'>GET IN TOUCH</button>
            </div>
