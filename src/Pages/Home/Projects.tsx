...
const Projects: React.FC = () => {
    return (
        <section className='bg-gray-bg px-8 py-12 flex flex-col items-center sm:px-8 md:px-36 lg:px-72 xl:px-[24rem] 2xl:px-[36rem] md:py-24 lg:py-36'>
            ...
            <button className='bg-pink text-white px-8 py-2 border-solid border-2 border-pink font-bold'>PROJECTS</button>
        </section>
    )
}
